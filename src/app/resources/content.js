...
const newsletter = {
    ...
    description: <>Hubungi kami jika Anda tertarik dengan layanan kami di bidang teknologi, pengembangan web, atau solusi IT untuk mendukung kebutuhan bisnis Anda.</>
}
...
const home = {
    ...
    description: 'Memberdayakan bisnis melalui solusi IT yang inovatif dan transformasi digital',
    headline: <>Transformasi Bisnis Melalui Teknologi</>,
    subline: <>Kami adalah <InlineCode>Solusi Digital Muda</InlineCode>, mitra terpercaya Anda dalam transformasi digital. Kami menyediakan solusi IT komprehensif untuk membantu bisnis Anda berkembang di era digital.</>
...
const about = {
    ...
    intro: {
        display: true,
        title: 'Visi & Misi',
        description: <>Solusi Digital Muda berkomitmen untuk menyediakan layanan IT komprehensif yang membantu bisnis dalam menghadapi tantangan era digital. Kami memahami bahwa tidak semua organisasi memiliki sumber daya untuk mengelola kebutuhan IT mereka secara internal, karena itu kami hadir sebagai solusi profesional untuk menjembatani kesenjangan tersebut.</>
    },
    work: {
        display: true,
        title: 'Layanan Kami',
        ...
        institutions: [
            {
                ...
                description: <>Proyek ini melibatkan pengembangan website untuk pemerintahan kota yang dirancang untuk meningkatkan transparansi, aksesibilitas, dan efisiensi layanan publik. Melalui platform ini, masyarakat dapat dengan mudah memperoleh informasi tentang program dan layanan yang tersedia, serta mengakses berbagai layanan administrasi secara digital.</>,
                images: [
                    {
                        src: '/images/projects/proyek/satuportal.png',
            ...
            },
            {
                ...
                description: <>Platform donasi yang kami kembangkan memungkinkan kreator konten untuk terhubung dengan pendukung mereka melalui donasi atau tip finansial. Platform ini tidak hanya memberi kreator sumber pendapatan tambahan, tetapi juga memperkuat komunitas di sekitar karya mereka. Sistem ini dirancang dengan kemudahan akses dan keamanan transaksi yang optimal, sehingga pendukung dapat memberikan donasi dengan nyaman.</>,
                images: [
                    {
                        src: '/images/projects/proyek/kreasikita.png',
                        alt: 'Platform Donasi',
